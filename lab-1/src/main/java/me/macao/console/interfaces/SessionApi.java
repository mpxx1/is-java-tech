...
/**
 * An interface representing a session API.
 */
public interface SessionApi {

  /**
   * Logs in a user to the session API.
   *
   ...
   */
  void login(@NonNull String bankName, long userId, short passwd)
          throws LoginException, NotPermitedException;

  /**
   * Logs in an admin to the session API.
   *
   ...
   */
  void adminLogin(short id, short passwd) throws LoginException, NotPermitedException;

  /**
   * Logs out the current user from the session API.
   */
  void logout();
